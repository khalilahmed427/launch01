...
while 1:
    ...
    while 1:
        ...
        if not ((abs(scs_goal_position[index] - scs1_present_position) > SCS_MOVING_STATUS_THRESHOLD) and (abs(scs_goal_position[index] - scs2_present_position) > SCS_MOVING_STATUS_THRESHOLD)):
            break
