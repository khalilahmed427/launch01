...
class sub:
    ...
    def servorun(self,data):
        ...
        b=int(2048+(round((data.position[1]*180/3.1428)*11.375)))
        c=int(1000-(round((data.position[2]*180/3.1428)*11.375)))
        d=int((round((data.position[3]*180/3.1428)*11.375)))
        #e=int(2047-(round((data.position[4]*180/3.1428)*11.375)))
        #f=int(2047-(round((data.position[5]*180/3.1428)*11.375)))
        
        scs_goal_position = [a,b,c,d]         # Goal position]         # Goal position
      ...
      #   param_goal_position6 = [SCS_LOBYTE(scs_goal_position[5]), SCS_HIBYTE(scs_goal_position[5])]
        param_goal_position=[param_goal_position1,param_goal_position2,param_goal_position3,param_goal_position4]
