...
class sub:
    ...
    def servorun(self,data):
        a=int((round(abs(data.position[0]*180/3.1428)*11.375)))
        b=int((round(abs(data.position[1]*180/3.1428)*11.375)))
        ...
        scs_goal_position = [a,b]         # Goal position]         # Goal position
      ...
      #   param_goal_position6 = [SCS_LOBYTE(scs_goal_position[5]), SCS_HIBYTE(scs_goal_position[5])]
        param_goal_position=[param_goal_position1,param_goal_position2]
