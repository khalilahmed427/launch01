...
class sub:
    def __init__(self):
        ...
        self.DEVICENAME                  = 'COM8'    # Check which port is being used on your controller
    ...
    def servorun(self,data):
        a=int((round((data.position[0]*180/3.1428)*11.375)))
        b=int(1024+(round((data.position[1]*180/3.1428)*11.375)))
        c=int(1024-(round((data.position[2]*180/3.1428)*11.375)))
        d=int(1024+(round((data.position[3]*180/3.1428)*11.375)))
        e=int((round((data.position[4]*180/3.1428)*11.375)))
        f=int((round((data.position[5]*180/3.1428)*11.375)))
        ...
        print("[ID:%03d] GoalPos:%03d PresPos:%03d PresSpd:%03d\t[ID:%03d] GoalPos:%03d PresPos:%03d PresSpd:%03d\t[ID:%03d] GoalPos:%03d PresPos:%03d PresSpd:%03d\t[ID:%03d] GoalPos:%03d PresPos:%03d PresSpd:%03d\t[ID:%03d] GoalPos:%03d PresPos:%03d PresSpd:%03d\t[ID:%03d] GoalPos:%03d PresPos:%03d PresSpd:%03d" 
                % (self.SCS1_ID, scs_goal_position[0], scs1_present_position, SCS_TOHOST(scs1_present_speed, 15), 
                    ...
                    self.SCS2_ID, scs_goal_position[2], scs2_present_position, SCS_TOHOST(scs3_present_speed, 15),
                    self.SCS2_ID, scs_goal_position[3], scs2_present_position, SCS_TOHOST(scs4_present_speed, 15),
                    self.SCS2_ID, scs_goal_position[4], scs2_present_position, SCS_TOHOST(scs5_present_speed, 15),
                    self.SCS2_ID, scs_goal_position[5], scs2_present_position, SCS_TOHOST(scs6_present_speed, 15)))
